        ...
        <div
          ...
          <header>
            ...
            <SmartLink
              ...
              passHref
              className={
                ' group-hover:text-[var(--heo-color-primary)] dark:hover:text-[#a99cf5] dark:group-hover:text-[#a99cf5] text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-xl font-extrabold leading-tight'
              }>
